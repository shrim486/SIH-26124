...
export default function AccidentsPage() {
  ...
  const load = async () => {
    try {
      setLoading(true);
      setAccidents(await governmentApi.getAccidents());
    } finally {
      setLoading(false);
    }
  };
  ...
  if (loading) {
    return <div className="loading-shell">Loading accident intelligence...</div>;
  }
    ...
    <div className="page-shell">
      <div className="page-header">
        <div>
          ...
          <h1>Accidents</h1>
          <p>AI-detected accident and dangerous-driving events.</p>
        </div>
